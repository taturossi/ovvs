...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2019 a las 17:34:35
...
--
-- Estructura de tabla para la tabla `anchobanda`
--

CREATE TABLE `anchobanda` (
  `idanchobanda` int(11) NOT NULL,
  `anchobanda` varchar(100) COLLATE latin1_spanish_ci NOT NULL
...
(141, 'Villarino', 1),
(142, 'Zárate', 1),
(143, '11 de Septiembre', 1),
(144, '20 de Junio', 1),
(145, '25 de Mayo', 1),
(146, 'Acassuso', 1),
(147, 'Adrogué', 1),
(148, 'Aldo Bonzi', 1),
(149, 'Área Reserva Cinturón Ecológico', 1),
(150, 'Avellaneda', 1),
(151, 'Banfield', 1),
(152, 'Barrio Parque', 1),
(153, 'Barrio Santa Teresita', 1),
(154, 'Beccar', 1),
(155, 'Bella Vista', 1),
(156, 'Berazategui', 1),
(157, 'Bernal Este', 1),
...
(179, 'Ezeiza', 1),
(180, 'Ezpeleta', 1),
(181, 'Florencio Varela', 1),
(182, 'Florida', 1),
(183, 'Francisco Álvarez', 1),
(184, 'Gerli', 1),
(185, 'Glew', 1),
(186, 'González Catán', 1),
(187, 'Gral. Lamadrid', 1),
(188, 'Grand Bourg', 1),
(189, 'Gregorio de Laferrere', 1),
(190, 'Guillermo Enrique Hudson', 1),
(191, 'Haedo', 1),
(192, 'Hurlingham', 1),
(193, 'Ing. Sourdeaux', 1),
(194, 'Isidro Casanova', 1),
(195, 'Ituzaingó', 1),
(196, 'José C. Paz', 1),
(197, 'José Ingenieros', 1),
(198, 'José Marmol', 1),
(199, 'La Lucila', 1),
(200, 'La Reja', 1),
(201, 'La Tablada', 1),
...
(203, 'Llavallol', 1),
(204, 'Loma Hermosa', 1),
(205, 'Lomas de Zamora', 1),
(206, 'Lomas del Millón', 1),
(207, 'Lomas del Mirador', 1),
(208, 'Longchamps', 1),
(209, 'Los Polvorines', 1),
(210, 'Luis Guillón', 1),
(211, 'Malvinas Argentinas', 1),
(212, 'Martín Coronado', 1),
(213, 'Martínez', 1),
(214, 'Merlo', 1),
(215, 'Ministro Rivadavia', 1),
(216, 'Monte Chingolo', 1),
(217, 'Monte Grande', 1),
(218, 'Moreno', 1),
(219, 'Morón', 1),
(220, 'Muñiz', 1),
...
(228, 'Pontevedra', 1),
(229, 'Quilmes', 1),
(230, 'Rafael Calzada', 1),
(231, 'Rafael Castillo', 1),
(232, 'Ramos Mejía', 1),
(233, 'Ranelagh', 1),
(234, 'Remedios de Escalada', 1),
(235, 'Sáenz Peña', 1),
(236, 'San Antonio de Padua', 1),
(237, 'San Fernando', 1),
(238, 'San Francisco Solano', 1),
(239, 'San Isidro', 1),
(240, 'San José', 1),
(241, 'San Justo', 1),
(242, 'San Martín', 1),
(243, 'San Miguel', 1),
(244, 'Santos Lugares', 1),
(245, 'Sarandí', 1),
(246, 'Sourigues', 1),
(247, 'Tapiales', 1),
(248, 'Temperley', 1),
(249, 'Tigre', 1),
(250, 'Tortuguitas', 1),
(251, 'Tristán Suárez', 1),
(252, 'Trujui', 1),
(253, 'Turdera', 1),
(254, 'Valentín Alsina', 1),
(255, 'Vicente López', 1),
(256, 'Villa Adelina', 1),
(257, 'Villa Ballester', 1),
(258, 'Villa Bosch', 1),
(259, 'Villa Caraza', 1),
(260, 'Villa Celina', 1),
(261, 'Villa Centenario', 1),
(262, 'Villa de Mayo', 1),
(263, 'Villa Diamante', 1),
(264, 'Villa Domínico', 1),
(265, 'Villa España', 1),
(266, 'Villa Fiorito', 1),
(267, 'Villa Guillermina', 1),
(268, 'Villa Insuperable', 1),
(269, 'Villa José León Suárez', 1),
(270, 'Villa La Florida', 1),
(271, 'Villa Luzuriaga', 1),
(272, 'Villa Martelli', 1),
(273, 'Villa Obrera', 1),
(274, 'Villa Progreso', 1),
(275, 'Villa Raffo', 1),
(276, 'Villa Sarmiento', 1),
(277, 'Villa Tesei', 1),
(278, 'Villa Udaondo', 1),
(279, 'Virrey del Pino', 1),
(280, 'Wilde', 1),
(281, 'William Morris', 1),
(282, 'Agronomía', 3),
(283, 'Almagro', 3),
(284, 'Balvanera', 3),
(285, 'Barracas', 3),
...
CREATE TABLE `equipo` (
  ...
  `Descripcion` varchar(100) COLLATE latin1_spanish_ci NOT NULL,
  `IdMarcaEquipo` int(11) NOT NULL,
  `IdModeloEquipo` int(11) NOT NULL,
...
INSERT INTO `equipo` (`idEquipo`, `codigo`, `Descripcion`, `IdMarcaEquipo`, `IdModeloEquipo`, `IdTorre`, `IdTipoHardware`, `IdTipoInstalacion`, `FechaAlta`, `FechaBaja`) VALUES
(1, 'EQ1', 'Equipo 1', 1, 1, NULL, 2, NULL, '2019-10-01', NULL),
(2, 'EQ2', 'Equipo 2', 1, 2, NULL, 1, NULL, '2019-10-01', NULL),
(3, 'EQ3', 'Equipo 3', 2, 3, NULL, 2, NULL, '2019-10-01', NULL),
(4, 'EQ8', 'Equipo 8', 4, 7, NULL, 4, NULL, '2019-10-22', '2019-10-27'),
(5, 'EQ11', 'asd', 3, 5, NULL, 3, NULL, '2019-10-27', '2019-10-27'),
(6, 'EQ12', 'asd', 3, 5, NULL, 3, NULL, '2019-10-27', NULL),
(7, 'Ant1', 'Antena 1', 3, 5, NULL, 4, NULL, '2019-10-28', NULL),
(8, 'Ant2', 'Antena 2', 4, 5, NULL, 4, NULL, '2019-10-28', NULL),
(9, 'ROU34', 'Router Siemens', 1, 1, NULL, 1, NULL, '2019-10-29', NULL),
(10, 'Rout6', 'Router Motorola', 3, 1, NULL, 1, NULL, '2019-10-29', NULL),
(11, 'Ant67', 'Antena Top 56', 4, 7, NULL, 4, NULL, '2019-10-29', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `equiponodo`
--

CREATE TABLE `equiponodo` (
  `idEquipoNodo` int(11) NOT NULL,
  `idEquipo` int(11) NOT NULL,
  `IdEquipoPadre` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `equiponodo`
--

INSERT INTO `equiponodo` (`idEquipoNodo`, `idEquipo`, `IdEquipoPadre`, `idNodo`, `FechaAsignacion`, `FechaBaja`) VALUES
(20, 7, 9, 18, '2019-10-29', NULL),
(19, 9, NULL, 18, '2019-10-29', NULL),
(18, 8, 1, 17, '2019-10-29', NULL),
(17, 1, 2, 17, '2019-10-29', NULL),
(16, 2, NULL, 17, '2019-10-29', NULL);
...
CREATE TABLE `frecuencias` (
  ...
  `frecuencia` varchar(100) COLLATE latin1_spanish_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `marcaequipo`
--
...
--
-- Volcado de datos para la tabla `marcaequipo`
--

INSERT INTO `marcaequipo` (`idMarcaEquipo`, `codigo`, `Descripcion`) VALUES
(1, 'M1', 'Marca 1'),
(2, 'M2', 'Marca 2'),
(3, 'M3', 'Marca 3'),
(4, 'M4', 'Marca 4');
...
--
-- Estructura de tabla para la tabla `modeloequipo`
--
...
CREATE TABLE `modeloequipo` (
  ...
  `idmarcamodelo` int(11) NOT NULL,
  `version` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

--
-- Volcado de datos para la tabla `modeloequipo`
--

INSERT INTO `modeloequipo` (`idmodeloequipo`, `codigo`, `descripcion`, `idmarcamodelo`, `version`) VALUES
(1, 'MO1', 'Modelo 1', 1, NULL),
(2, 'MO2', 'Modelo 2', 1, NULL),
(3, 'MO3', 'Modelo 3', 2, NULL),
(4, 'MO4', 'Modelo 4', 2, NULL),
(5, 'MO5', 'Modelo 5', 3, NULL),
(6, 'MO6', 'Modelo 6', 3, NULL),
(7, 'MO7', 'Modelo 7', 4, NULL),
(8, 'MO8', 'Modelo 8', 5, NULL);
...
CREATE TABLE `nodos` (
  `IdNodo` int(11) NOT NULL,
  `Codigo` varchar(10) COLLATE latin1_spanish_ci NOT NULL,
  `LinkMaps` text COLLATE latin1_spanish_ci,
  `Descripcion` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `IdCiudad` int(11) NOT NULL,
  `OtrosDetalles` text COLLATE latin1_spanish_ci,
  `FechaAlta` date NOT NULL,
  `FechaBaja` date DEFAULT NULL,
  `UPS` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `Baterias` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `Servidor` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `PanelSolar` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `Regulador` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `BocasElectricas` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `nodos` (`IdNodo`, `Codigo`, `LinkMaps`, `Descripcion`, `IdCiudad`, `OtrosDetalles`, `FechaAlta`, `FechaBaja`, `UPS`, `Baterias`, `Servidor`, `PanelSolar`, `Regulador`, `BocasElectricas`) VALUES
(1, 'nod1', 'https://goo.gl/maps/G7PS148Y8S7zmodT6', 'nodo 1', 658, '', '2019-10-28', NULL, '', '', '', '', '', ''),
(2, 'nod2', 'https://goo.gl/maps/w4xTPBZEazWyk63G8', 'nodo 2', 829, '', '2019-10-28', NULL, '', '', '', '', 'si', '8'),
(18, 'nod678', '', 'nodo sin switch', 1286, '', '2019-10-29', NULL, '', '', '', '', '', ''),
(17, 'nod66', '', 'nodo test 66', 928, '', '2019-10-29', NULL, '', '', '', '', '', ''),
(16, 'Not55', '', 'Nodo test 56', 1346, '', '2019-10-29', NULL, '', '', '', '', '', ''),
(15, 'NodT5', '', 'Nodo Test 5', 1429, '', '2019-10-29', NULL, '', '', '', '', '', ''),
(14, 'NodT3', '', 'Nodo Test 4', 1431, '', '2019-10-29', NULL, '', '', '', '', '', ''),
(13, 'NodT2', 'https://goo.gl/maps/aCeW8scwTPfW5pVbA', 'Nodo Test 2', 545, '', '2019-10-29', NULL, '', '', '', '', '', '');
...
INSERT INTO `tipoequipo` (`idTipoEquipo`, `Codigo`, `Descripcion`) VALUES
(1, 'Rout1', 'Router'),
(2, 'SW1', 'Switch'),
(3, 'HUB1', 'HUB'),
(4, 'ANT', 'Antena');
...
CREATE TABLE `tipoinstalacion` (
  `idTipoInstalacion` int(11) NOT NULL,
  `codigo` varchar(10) COLLATE latin1_spanish_ci NOT NULL,
  `Descripcion` varchar(100) COLLATE latin1_spanish_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `tipoinstalacion` (`idTipoInstalacion`, `codigo`, `Descripcion`) VALUES
(1, 'TI1', 'Prestamo'),
(2, 'TI2', 'Vendido');
...
--
-- Indices de la tabla `anchobanda`
--
ALTER TABLE `anchobanda`
  ADD PRIMARY KEY (`idanchobanda`);
...
--
-- Indices de la tabla `equiponodo`
--
ALTER TABLE `equiponodo`
  ADD PRIMARY KEY (`idEquipoNodo`);
...
--
-- Indices de la tabla `marcaequipo`
--
ALTER TABLE `marcaequipo`
  ADD PRIMARY KEY (`idMarcaEquipo`),
  ADD UNIQUE KEY `codigo` (`codigo`);

--
-- Indices de la tabla `modeloequipo`
--
ALTER TABLE `modeloequipo`
  ADD PRIMARY KEY (`idmodeloequipo`),
  ADD UNIQUE KEY `codigo` (`codigo`);
...
ALTER TABLE `tipoinstalacion`
  ADD PRIMARY KEY (`idTipoInstalacion`),
  ADD UNIQUE KEY `codigo` (`codigo`);
...
--
-- AUTO_INCREMENT de la tabla `anchobanda`
--
ALTER TABLE `anchobanda`
  MODIFY `idanchobanda` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `equiponodo`
--
ALTER TABLE `equiponodo`
  MODIFY `idEquipoNodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
-- AUTO_INCREMENT de la tabla `marcaequipo`
--
ALTER TABLE `marcaequipo`
  MODIFY `idMarcaEquipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `modeloequipo`
--
ALTER TABLE `modeloequipo`
  MODIFY `idmodeloequipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `nodos`
--
ALTER TABLE `nodos`
  MODIFY `IdNodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `tipoinstalacion`
  MODIFY `idTipoInstalacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
